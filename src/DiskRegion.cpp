...
using namespace std;
DiskRegion::DiskRegion(int start, int end, int tag_id, Disk &rDisk)
	: region_start(start),
	  region_end(end),
	  tag_id(tag_id),
	  rDisk(rDisk)
...
// 同时新往list与set中插入新section 并更新spacecount
